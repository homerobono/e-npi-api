...
router.post('/files/upload', authService.authorize, fileController.upload, fileController.uploadResponse)
router.post('/files/remove', authService.authorize, fileController.upload, fileController.remove)
router.post('/files/createFolder', authService.authorize, fileController.upload, fileController.createFolder)
